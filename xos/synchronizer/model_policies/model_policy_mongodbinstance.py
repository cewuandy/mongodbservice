...
class MongoDBServiceInstancePolicy(Policy):
    model_name = "MongoDBServiceInstance"

    def handle_create(self, service_instance):
        log.info("handle_create MongoDBServiceInstance")
        return self.handle_update(service_instance)


    def handle_update(self, service_instance):
        log.info("handle_update MongoDBServiceInstance")
        owner = KubernetesService.objects.first()

        yaml_file = ["nextepc-mongodb-deployment.yaml", "nextepc-mongodb-service.yaml", "nextepc-mongodb-pv.yaml", "nextepc-mongodb-pvc.yaml"]
