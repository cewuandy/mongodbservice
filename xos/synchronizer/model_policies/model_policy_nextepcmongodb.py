...
class NextEPCMongoDBInstancePolicy(Policy):
    model_name = "NextEPCMongoDBInstance"

    def handle_create(self, service_instance):
        log.info("handle_create NextEPCMongoDBInstance")
        return self.handle_update(service_instance)


    def handle_update(self, service_instance):
        log.info("handle_update NextEPCMongoDBInstance")
        owner = KubernetesService.objects.first()
        input_file=os.path.join(os.path.abspath(os.path.dirname(os.path.realpath(__file__))), "nextepc-mongodb.yaml")
    ...
    def handle_delete(self, service_instance):
        log.info("handle_delete NextEPCMongoDBInstance")
